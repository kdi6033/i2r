...
| `get_status`        | `gs`             | 보드 상태 요청 (온도, 습도, in/out 등) <br> 기능: 기기의 현재 상태 요청 {"c": "gs","m": "EC:64:C9:43:E8:B8"} <br> 응답 예시: {"type": 3,"email": "kdi6033@gmail.com","m": "EC:64:C9:43:E8:B8","temp": 28.4,"humi": 38,"in": [0, 0, 0, 0],"out": [0, 0, 0, 0]} <br> 응답 예시: {"type": 3,"email": "kdi6033@gmail.com","m": "EC:64:C9:43:E8:B8","temp": 28.4,"humi": 38,"in": [0, 0, 0, 0],"out": [0, 0, 0, 0]} |
...
| **`get_status`** (`gs`)         | `{ "c": "gs", "m": "EC:64:C9:43:E8:B8" }`                                                                                                                      | 지정 보드의 현재 상태를 요청합니다. 응답으로는 온도, 습도, 입력포트 상태(`in`), 출력포트 상태(`out`), MAC, email 등의 정보가 포함됩니다. 실시간 모니터링 시 사용됩니다.                                    |
| **`schedule_output`** (`sch`)   | `{ "c": "sch", "m": "A0:B7:65:CD:4D:34", "o": "insert", "n": 0, "sH": 9, "sM": 0, "eH": 10, "eM": 0, "rM": "d", "dW": 1 }`                                     | 출력 핀의 동작을 시간 기반으로 자동화합니다. 시작시간(`sH:sM`)과 종료시간(`eH:eM`), 반복(`rM`=daily:`d` / weekly:`w`), 요일(`dW`) 등을 설정하여 예약 제어가 가능합니다.                         |
